...
const Hero = () => {
  ...
  return (
    <div className='container mx-auto my-10 2xl:px-20'>
        <div className='py-16 text-center text-white bg-gradient-to-r from-purple-800 to-purple-950 x-2 rounded-xl'>
            ...
            <div className='flex items-center justify-between max-w-xl pl-4 mx-4 text-gray-600 bg-white rounded sm:mx-auto '>
                <div className='flex items-center '>
                    ...
                    <input type="text" placeholder='Search for jobs' className='w-full p-2 rounded outline-none max-sm:text-xs' ref={titleRef}/>
                </div>
                <div className='flex items-center'>
                    <img className='h-4 sm:h-5' src={assets.location_icon} alt="" />
                    <input type="text" placeholder='Location' className='w-full p-2 rounded outline-none max-sm:text-xs' ref={locationRef}/>
                </div>
