  ...
  return (
   <>
    ...
    <div className='container px-4 min-h-[65vh] 2xl:px-20 mx-auto my-10'>
      <h2 className='text-xl font-semibold'>Youe Resume</h2>
      <div className='flex gap-2 mt-3 mb-6'>
        {
          ...
          ? <>
              <label className='flex items-center' htmlFor="resumeUpload">
                ...
                <input id='resumeUpload' accept='appication/pdf' type="file" hidden onChange={e=> setIsEdit(e.target.files[0])}/>
          ...
          : <div className='flex gap-2'>
              <a href="" className='px-4 py-2 text-blue-600 bg-blue-100 rounded-lg'>
                Resume
              </a>
