    ...
    <div className='container max-w-5xl p-4'>
        <div className='overflow-x-auto'>
          <table className='min-w-full bg-white border-gray-200 max-sm:text-sm'>
            <thead >
              <tr>
                <th className='px-4 py-2 border-b text-lef max-sm:hiddent'>#</th>
                <th className='px-4 py-2 text-left border-b'>Job Title</th>
                <th className='px-4 py-2 text-left border-b max-sm:hiddent'>Date</th>
                <th className='px-4 py-2 text-left border-b max-sm:hiddent'>Location</th>
            ...
            <tbody>
              {manageJobsData.map((job,index)=>(
                  <tr index={index} className='text-gray-700'>
