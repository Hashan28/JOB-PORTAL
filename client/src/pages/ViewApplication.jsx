        ...
        <table className='w-full max-w-4xl bg-white border border-gray-200 max-sm:text-sm'>
          <thead>
            <tr className='border-b'>
              ...
              <th lassName='py-2 px-4 text-left'>User name</th>
              <th lassName='py-2 px-4 text-left max-sm:hidden'>Job Title</th>
              <th lassName='py-2 px-4 text-left max-sm:hidden'>Location</th>
              <th lassName='py-2 px-4 text-left'>Resume</th>
              <th lassName='py-2 px-4 text-left'>Action</th>
            </tr>
          </thead>
          <tbody>
